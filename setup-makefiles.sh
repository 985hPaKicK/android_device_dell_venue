...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__VENDOR__/__DEVICE__/proprietary/etc/wlan/nvram_BPF.txt:system/etc/wlan/nvram_BPF.txt \\
    vendor/__VENDOR__/__DEVICE__/proprietary/etc/wlan/nvram_LNA.txt:system/etc/wlan/nvram_LNA.txt \\
