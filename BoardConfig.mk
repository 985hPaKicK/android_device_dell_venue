...
WIFI_DRIVER_FW_STA_PATH := "/system/etc/wlan/sdio-g-cdc-full11n-reclaim-roml-wme-aoe-pktfilter-keepalive-wapi.bin"
WIFI_DRIVER_FW_AP_PATH := "/system/etc/wlan/sdio-g-cdc-roml-reclaim-wme-apsta-idsup-idauth.bin"
...
BOARD_KERNEL_CMDLINE := androidboot.hardware=venue no_console_suspend
BOARD_KERNEL_BASE := 0x20000000
